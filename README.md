...
- � **自动备份系统** - 支持完整备份、快速备份和定时备份
- 📋 **CLI控制面板** - 交互式命令行界面，支持进度条和彩色输出
- 📁 **文件管理** - 快速访问服务器目录和日志
- 🛡️ **错误处理和日志** - 完善的错误处理和操作日志记录
...
| `common.sh` | 通用函数库，包含错误处理、日志系统和UI增强 |
| `backup.sh` | 自动备份脚本，支持完整备份、快速备份和恢复 |
